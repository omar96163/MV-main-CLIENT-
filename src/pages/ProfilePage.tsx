...
const ProfilePage: React.FC = () => {
  ...
  const hasInsufficientPoints =
    availablePoints < 20 && contact && !contact.isUnlocked;
            ...
            {contact.isUnlocked || user?.id === contact?.uploadedBy ? (
              ...
              <div className="text-center">
                ...
                <p className="text-gray-600 mb-4">
                  Contact details are locked. Unlock to view email and phone
                  number.
                </p>
          ...
          <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
            ...
            <div className="space-y-3">
              ...
              <div className="flex justify-between">
                ...
                <span className="font-medium">
                  {contact.hasContactInfo ? "Yes" : "No"}
                </span>
              </div>
              <div className="flex justify-between">
                <span className="text-gray-600">Has Work Experience:</span>
                <span className="font-medium">
                  {contact.workExperience ? "Yes" : "No"}
                </span>
              </div>
            </div>
          </div>
